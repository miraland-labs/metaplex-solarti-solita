...
} from '@metaplex-solarti/beet-solana'
...
export const BEET_SOLANA_PACKAGE = '@metaplex-solarti/beet-solana'
export const SOLANA_WEB3_PACKAGE = '@solarti/web3.js'
export const SOLANA_SPL_TOKEN_PACKAGE = '@solarti/spl-token'
